@extends('layouts.app')
@section('title', 'Operations | Travel Shravel')
@section('content')
                    ...
                    <div class="contactapp-detail-wrap">
                        <div class="contact-body">
                            <div data-simplebar class="nicescroll-bar">
                                ...
                                <form method="GET" action="{{ route('operations.index') }}" class="row g-3 mb-4"
                                    id="operationsFiltersForm">
                                ...
                                <table class="table table-striped small table-bordered w-100 mb-5" id="operationsTable">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="8" class="text-center">No operations found</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>

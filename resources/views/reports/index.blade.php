                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar avatar-icon avatar-lg avatar-light-success">
                                                        <span class="avatar-icon"><i data-feather="check-circle"></i></span>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar avatar-icon avatar-lg avatar-light-info">
                                                        <span class="avatar-icon"><i data-feather="dollar-sign"></i></span>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div class="text-muted fs-6">Total Revenue</div>
                                                    <div class="fs-4 fw-semibold">₹{{ number_format($stats['total_revenue'], 2) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="fs-4 fw-semibold">{{ $stats['pending_deliveries'] }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar avatar-icon avatar-lg avatar-light-danger">
                                                        <span class="avatar-icon"><i data-feather="alert-circle"></i></span>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="card border-warning">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <div class="avatar avatar-icon avatar-lg avatar-light-warning">
                                                        <span class="avatar-icon"><i data-feather="trending-down"></i></span>
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div class="text-muted fs-6">Total Cost</div>
                                                    <div class="fs-4 fw-semibold">₹{{ number_format($stats['total_cost'], 2) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3 mb-3">
                                                    <a href="{{ route('reports.leads') }}" class="btn btn-outline-primary w-100">
                                                        <i data-feather="users" class="me-2"></i> Leads Report
                                                    </a>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <a href="{{ route('reports.revenue') }}" class="btn btn-outline-success w-100">
                                                        <i data-feather="dollar-sign" class="me-2"></i> Revenue Report
                                                    </a>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <a href="{{ route('reports.profit') }}" class="btn btn-outline-info w-100">
                                                        <i data-feather="trending-up" class="me-2"></i> Profit Report
                                                    </a>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <a href="{{ route('reports.export.leads') }}" class="btn btn-outline-secondary w-100">
                                                    ...
                                                    <tbody>
                                                        @forelse($recentLeads as $lead)
                                                            <tr>
                                                                ...
                                                                <td><a href="{{ route('leads.show', $lead->id) }}" class="btn btn-sm btn-outline-primary">View</a></td>
                                                            </tr>
                                                        @empty
                                                            <tr><td colspan="5" class="text-center">No recent leads</td></tr>
                                                        @endforelse
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    <div class="card-body p-2">
                                                        <div class="d-flex justify-content-between align-items-start">
                                                            <div>
                                                                ...
                                                                <small class="d-block text-muted">{{ $followUp->lead->tsq }}</small>
                                                                <small class="text-danger">{{ $followUp->follow_up_date->format('d M, Y') }}</small>
                                                            </div>
                                                            <a href="{{ route('leads.show', $followUp->lead->id) }}" class="btn btn-sm btn-outline-primary">View</a>
                                                        </div>
                                                        <p class="mb-0 mt-1 small">{{ Str::limit($followUp->remark, 50) }}</p>
                                                    </div>
                                                </div>
                                            @empty

                    ...
                    <div class="contactapp-detail-wrap">
                        ...
                        <div class="contact-body">
                            <div data-simplebar class="nicescroll-bar">
                                ...
                                <form action="{{ route('hr.employees.update', $employee) }}" method="POST" class="row g-3">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="department" class="form-select form-select-sm">
                                            ...
                                            <option value="Sales Manager" {{ old('department', $employee->department) == 'Sales Manager' ? 'selected' : '' }}>Sales Manager</option>
                                            <option value="Operation" {{ old('department', $employee->department) == 'Operation' ? 'selected' : '' }}>Operation</option>
                                            <option value="Operation Manager" {{ old('department', $employee->department) == 'Operation Manager' ? 'selected' : '' }}>Operation Manager</option>
                                            <option value="Accounts" {{ old('department', $employee->department) == 'Accounts' ? 'selected' : '' }}>Accounts</option>
                                            <option value="Accounts Manager" {{ old('department', $employee->department) == 'Accounts Manager' ? 'selected' : '' }}>Accounts Manager</option>
                                            <option value="Post Sales" {{ old('department', $employee->department) == 'Post Sales' ? 'selected' : '' }}>Post Sales</option>
                                            <option value="Post Sales Manager" {{ old('department', $employee->department) == 'Post Sales Manager' ? 'selected' : '' }}>Post Sales Manager</option>
                                            <option value="Delivery" {{ old('department', $employee->department) == 'Delivery' ? 'selected' : '' }}>Delivery</option>
                                            <option value="Delivery Manager" {{ old('department', $employee->department) == 'Delivery Manager' ? 'selected' : '' }}>Delivery Manager</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="designation" class="form-control form-control-sm"
                                            value="{{ old('designation', $employee->designation) }}" placeholder="e.g. Manager, Executive">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="work_email" class="form-control form-control-sm"
                                            value="{{ old('work_email', $employee->work_email) }}" placeholder="employee@travelshravel.com">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="crm_access_user_id" class="form-control form-control-sm"
                                            value="{{ old('crm_access_user_id', $employee->crm_access_user_id) }}" placeholder="sales1, ops1, ps1, etc">
                                        <small class="text-muted">CRM user ID for system access</small>
                                    </div>

                                    <div class="col-12 mt-4">
                                        <div class="d-flex justify-content-end gap-2">
                                            <a href="{{ route('hr.employees.index') }}" class="btn btn-light border">Cancel</a>

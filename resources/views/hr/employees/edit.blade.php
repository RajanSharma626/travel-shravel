                                ...
                                <form action="{{ route('hr.employees.update', $employee) }}" method="POST" class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="employee_id" class="form-control form-control-sm"
                                               value="{{ old('employee_id', $employee->employee_id) }}" placeholder="Auto if blank">
                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select name="salutation" class="form-select form-select-sm">
                                                            ...
                                                            <option value="Prof" {{ old('salutation', $employee->salutation) == 'Prof' ? 'selected' : '' }}>Prof</option>
                                                            <option value="Other" {{ old('salutation', $employee->salutation) == 'Other' ? 'selected' : '' }}>Other</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                               ...
                                               value="{{ old('date_of_birth', $employee->date_of_birth ? $employee->date_of_birth->format('Y-m-d') : ($employee->dob ? $employee->dob->format('Y-m-d') : '')) }}">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select name="department" class="form-select form-select-sm">
                                                            ...
                                                            <option value="Post Sales" {{ old('department', $employee->department) == 'Post Sales' ? 'selected' : '' }}>Post Sales</option>
                                               ...
                                               value="{{ old('designation', $employee->designation) }}">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select name="reporting_manager" class="form-select form-select-sm">
                                                            <option value="">Select</option>
                                                            <option value="Sales Manager" {{ old('reporting_manager', $employee->reporting_manager) == 'Sales Manager' ? 'selected' : '' }}>Sales Manager</option>
                                                            <option value="Operation Manager" {{ old('reporting_manager', $employee->reporting_manager) == 'Operation Manager' ? 'selected' : '' }}>Operation Manager</option>
                                                            <option value="Accounts Manager" {{ old('reporting_manager', $employee->reporting_manager) == 'Accounts Manager' ? 'selected' : '' }}>Accounts Manager</option>
                                                            <option value="Post Sales Manager" {{ old('reporting_manager', $employee->reporting_manager) == 'Post Sales Manager' ? 'selected' : '' }}>Post Sales Manager</option>
                                                            <option value="Delivery Manager" {{ old('reporting_manager', $employee->reporting_manager) == 'Delivery Manager' ? 'selected' : '' }}>Delivery Manager</option>
                                                            <option value="HR Manager" {{ old('reporting_manager', $employee->reporting_manager) == 'HR Manager' ? 'selected' : '' }}>HR Manager</option>
                                                            <option value="Admin" {{ old('reporting_manager', $employee->reporting_manager) == 'Admin' ? 'selected' : '' }}>Admin</option>
                                                            <option value="Other" {{ old('reporting_manager', $employee->reporting_manager) == 'Other' ? 'selected' : '' }}>Other</option>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="employment_type" class="form-select form-select-sm">
                                            ...
                                            <option value="Other" {{ old('employment_type', $employee->employment_type) == 'Other' ? 'selected' : '' }}>Other</option>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <select name="employment_status" class="form-select form-select-sm">
                                            ...
                                            <option value="On Notice" {{ old('employment_status', $employee->employment_status) == 'On Notice' ? 'selected' : '' }}>On Notice</option>
                                            <option value="On Hold" {{ old('employment_status', $employee->employment_status) == 'On Hold' ? 'selected' : '' }}>On Hold</option>
                                        </select>
                                    </div>
                                                    <div class="col-md-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="user_id" class="form-control form-control-sm"
                                               value="{{ old('user_id', $employee->user_id) }}" placeholder="sales1 / ops1 / ps1">
                                    </div>
                                                    <div class="col-md-3">
                                        ...
                                        <select name="role" class="form-select form-select-sm" required>
                                            ...
                                            <option value="Sales Manager" {{ old('role', $employee->role) == 'Sales Manager' ? 'selected' : '' }}>Sales Manager</option>
                                            <option value="Operation Manager" {{ old('role', $employee->role) == 'Operation Manager' ? 'selected' : '' }}>Operation Manager</option>
                                            <option value="Accounts Manager" {{ old('role', $employee->role) == 'Accounts Manager' ? 'selected' : '' }}>Accounts Manager</option>
                                            <option value="Post Sales Manager" {{ old('role', $employee->role) == 'Post Sales Manager' ? 'selected' : '' }}>Post Sales Manager</option>
                                            <option value="Delivery Manager" {{ old('role', $employee->role) == 'Delivery Manager' ? 'selected' : '' }}>Delivery Manager</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check mt-1">
                                            <input class="form-check-input" type="checkbox" name="permanent_same_as_present" value="1"
                                                   id="permanentSameAsPresent" {{ old('permanent_same_as_present', $employee->permanent_same_as_present) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="incentive_eligibility" value="1"
                                                   id="incentiveEligibility" {{ old('incentive_eligibility', $employee->incentive_eligibility) ? 'checked' : '' }}>
                                        ...
                                        <input type="text" name="incentive_type" class="form-control form-control-sm"
                                               value="{{ old('incentive_type', $employee->incentive_type) }}" placeholder="Fixed / %age">
                                    </div>
                                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="incentive_payout_date" class="form-control form-control-sm"
                                               value="{{ old('incentive_payout_date', $employee->incentive_payout_date) }}" placeholder="e.g. 21 of every month">
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="salary_structure" class="form-control form-control-sm"
                                               value="{{ old('salary_structure', $employee->salary_structure) }}" placeholder="CTC / Gross / Net">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="exit_initiated_by" class="form-control form-control-sm"
                                               value="{{ old('exit_initiated_by', $employee->exit_initiated_by) }}" placeholder="Employee / HR">
                                    </div>
                                                    <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-check mt-4">
                                                                    <input class="form-check-input" type="checkbox" name="service_certificate_issued" value="1"
                                                                           id="serviceCertificateIssued" {{ old('service_certificate_issued', $employee->service_certificate_issued) ? 'checked' : '' }}>
                                                                ...
                                                                <div class="d-flex flex-wrap gap-3">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" name="handed_over_laptop" value="1"
                                                                               id="handedOverLaptop" {{ old('handed_over_laptop', $employee->handed_over_laptop) ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" name="handed_over_mobile" value="1"
                                                                               id="handedOverMobile" {{ old('handed_over_mobile', $employee->handed_over_mobile) ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" name="handed_over_id_card" value="1"
                                                                               id="handedOverIdCard" {{ old('handed_over_id_card', $employee->handed_over_id_card) ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="checkbox" name="all_dues_cleared" value="1"
                                                                               id="allDuesCleared" {{ old('all_dues_cleared', $employee->all_dues_cleared) ? 'checked' : '' }}>
